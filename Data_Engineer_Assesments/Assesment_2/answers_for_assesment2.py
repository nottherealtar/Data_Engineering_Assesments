...
# 4 How do we Merge weather_data and solar_panel_output on 'inverter_serial' ?
# 4.1
...
# 5.1 
integrated_data = pd.merge(integrated_data, energy_consumption, on='inverter_serial')
